  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: React.Key) => {
        ...
        const logoName = item.name || (!isNodeItem ? item.alt : undefined);
        ...
        const content = showNames && logoName ? (
          <div className={`flex items-center gap-1 px-2 py-1 rounded border bg-transparent transition-colors duration-300 ${
            isDarkTheme 
              ? "border-gray-600" 
              : "border-gray-300"
          }`}>
      ...
      [scaleOnHover, showNames, isDarkTheme]
    );
